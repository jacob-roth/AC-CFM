function result = accfm_pdf_batch_comparison(network, distribName, distribParams, number_of_scenarios, settings, output_file)
...
%   Covered by the 3-clause BSD License (see LICENSE file for details).
    ...
    if ~iscell(network)
        ...
        % run AC-CFM
        result = accfm_branch_scenarios_comparison(network, scenarios, settings);
    else
